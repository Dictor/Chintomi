<?php
	...
	class ctr_list {
		...
		public static function ShowToolbar(int $bookcnt, string $username) {
			...
			echo '<div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="#">관리</a><a class="dropdown-item" href="./app.php?dest=list&action=logout">로그아웃</a></div></div>';
